...
Плюсы: гибкость, безопасность, управляемость данных.
Минусы: задержка данных, нагрузка на сеть.

Push система мониторинга:
Плюсы: мгновенные обновления, минимальная задержка.
Минусы: требует конфигурацию агентов, потенциальные безопасностные риски.
